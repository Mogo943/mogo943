...
<p align="center">
  Desarrollador Full Stack 💻 (Backend Focus) | QA Automation 🔍
</p>
...
Desarrollador Full Stack 💻 con un enfoque especializado en Backend (Node.js, Nest.js, Express) y una sólida experiencia en Quality Assurance y Automatización. Mi perfil combina habilidades de desarrollo con un fuerte énfasis en la validación de procesos, la automatización de pruebas, la documentación y la mejora continua.
...
- Automatización de pruebas End-to-End (E2E) utilizando Playwright y TypeScript, aplicando patrones de diseño como Page Object Model (POM).
...
#### 4. ✅ Proyecto de Web Testing (CoderHouse):
...
Si buscas un perfil Full Stack detallista, con un enfoque en la calidad del software (QA Automation) y la eficiencia:
